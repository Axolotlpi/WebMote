...
function JsonEditor({object, deleteObject, setObject}) {
    ...
    const saveSelf = (e) => {
        setObject({...object ,templateLink:urlRef, icon:iconRef});
        e.preventDefault();
    }
                ...
                <form onSubmit={saveSelf} >
                    <div className="row">
                        <div className="input-field col s12">
                            <label htmlFor="url">{"URL and Icon:"}</label>
                            <textarea id="url" ref={urlRef} defaultValue={object.templateLink} className="materialize-textarea"></textarea>
                            <textarea id="icon" ref={iconRef} defaultValue={object.icon} className="materialize-textarea"></textarea>
                        </div>
                    </div>
